...
import { Search, LayoutDashboard, Wallet, LogOut, ChevronDown, Users2 } from 'lucide-react'
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {dropdownOpen && (
              <div className="absolute right-0 top-full mt-1 w-56 card shadow-lg border border-slate-200 py-1 z-50 animate-fade-in">
                ...
                <div className="py-1">
                  <Link href="/crm" className="flex items-center gap-2.5 px-4 py-2 text-sm text-slate-700 hover:bg-slate-50"
                    onClick={() => setDropdownOpen(false)}>
                    <Users2 className="w-4 h-4 text-slate-400" /> Mon CRM
                  </Link>
                  <Link href="/wallet" className="flex items-center gap-2.5 px-4 py-2 text-sm text-slate-700 hover:bg-slate-50"
                    onClick={() => setDropdownOpen(false)}>
                    <Wallet className="w-4 h-4 text-slate-400" /> Mes crédits
                  </Link>
